...
public class ReflectTest {
    ...
    public static void test(ReflectTest p0,
                            List<ReflectTest> p1,
                            Map<String, ReflectTest> p2,
                            List<String>[] p3,
                            Map<String, ReflectTest>[] p4,
                            List<? extends ReflectTest> p5,
                            Map<? extends ReflectTest, ? super ReflectTest> p6
                            //T p7
    ) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < methods.length; i++) {
            ...
            if (oneMethod.getName().equals("test")) {
                ...
                //第三个参数，Map<String,ReflectTest> p2
                Type type2 = types[2];
                ...
                //第五个参数，Map<String,ReflectTest>[] p4
                Type type4 = types[4];
                ...
                //第六个参数，List<? extends ReflectTest> p5
                Type type5 = types[5];
                ...
                //第七个参数，Map<? extends ReflectTest,? super ReflectTest> p6
                Type type6 = types[6];
